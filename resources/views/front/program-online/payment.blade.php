                    ...
                    <div class="event__sidebar__wraper" data-aos="fade-up">
                        ...
                        <div class="course__summery__lists">
                            <ul>
                                ...
                                <li>
                                    <div class="course__summery__item">
                                        <span class="sb_label">Tanggal Kursus</span><span class="sb_content">{{ $transaction->program_date ? $transaction->program_date : '-'}}</span>
                                    </div>
                                </li>

                                <li>
                                    <div class="course__summery__item">
                                        <span class="sb_label">Jam Kursus</span><span class="sb_content">{{ $transaction->program_time ? $transaction->program_time : '-'}} WIB</span>
                                    </div>
                                </li>
                                ...
                                <li>
                                    <div class="course__summery__item">
                                        <span class="sb_label"><strong>Subtotal</strong></span><span class="sb_content"><strong>Rp. {{ number_format($transaction->program->price) }}</strong></span>
                                    </div>
                                </li>
                                ...
                                <li>
                                    <div class="course__summery__item">
                                        <span class="sb_label"><strong>Total Pembayaran</strong></span><span class="sb_content"><strong>Rp. {{ number_format($transaction->program->price - $transaction->discount) }}</strong></span>
                                    </div>
                                </li>
                        ...
                        <div class="course__summery__button">
                            ...
                            <button class="default__button" id="pay-button">Bayar Sekarang</button>
    ...
    document.getElementById('pay-button').onclick = function() {
        snap.pay('{{$transaction->snap_token}}', {
            onSuccess: function(result) {
                window.location.href = '{{ route("front.program-online.paymentSuccess", $transaction->id)}}';
            },
